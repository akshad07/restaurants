...
// custom added script for navbar...
  function toggleNavSlide() {
    var currentPosition = $(".navbar-collapse").css("left" );
    if(currentPosition == "0px"){
      $(".navbar-collapse").animate({left: "-241px"}, 400 );
    }
    else {
      $(".navbar-collapse").animate({left: "0"}, 400 );
    }
  }
  $(".navbar-toggler-custom").on("click", toggleNavSlide);
}); // PreLoader
